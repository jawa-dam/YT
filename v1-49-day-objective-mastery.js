...
(() => {
  ...
  function ensureStyles(){
    ...
    const style=document.createElement("style"); style.id="v1-49-day-objective-mastery-styles"; style.textContent=`
      ...
      .v1-49-mastery-head{display:flex;align-items:flex-end;justify-content:space-between;gap:10px}.v1-49-mastery-kicker{display:block;color:#155eef;font-size:9px;font-weight:1000;letter-spacing:.13em}.v1-49-mastery-head h2{margin:4px 0 0;color:#102a43;font-size:18px;line-height:1.08}.v1-49-mastery-badge{padding:5px 7px;border-radius:8px;background:#eef3ff;color:#155eef;font-size:8px;font-weight:1000;white-space:nowrap}
      ...
      @media(max-width:420px){.v1-49-day-objective-mastery{padding:12px;border-radius:16px}.v1-49-mastery-head h2{font-size:16px}.v1-49-mastery-kicker,.v1-49-mastery-badge{font-size:7px}.v1-49-mastery-copy{font-size:10px}.v1-49-question h3{font-size:13px}.v1-49-choices button{font-size:10px;min-height:40px}}
