...
function init(){
 ...
 guide.innerHTML=
 '<button class="gei-portfolio-mascot" type="button" aria-label="Ask Adam the Dam Guide about the research papers">'+
   '<span class="gei-portfolio-mascot-glow" aria-hidden="true"></span>'+
   '<img src="'+MASCOT_URL+'" alt="Adam the Dam Guide mascot" decoding="async" fetchpriority="high">'+
  '</button>'+
 '<div class="gei-portfolio-guide-copy"><span class="screen-kicker">THE DAM GUIDE</span><h2>Meet the Research Map</h2><p>Tap Adam to get a quick guide to the papers in this library.</p><span class="gei-portfolio-guide-hint">10 WORKS • RESEARCH • DISCOVERY</span></div>';
 ...
 dialog.innerHTML=
  ...
  '<section class="gei-portfolio-dialog-card" role="dialog" aria-modal="true" aria-labelledby="gei-portfolio-guide-title">'+
   ...
   '<div class="gei-portfolio-dialog-mascot"><img src="'+MASCOT_URL+'" alt="Adam the Dam Guide mascot"></div>'+
   '<div class="gei-portfolio-dialog-copy"><span class="screen-kicker">ADAM • THE DAM GUIDE</span><h2 id="gei-portfolio-guide-title">What Are These Papers About?</h2><p class="gei-portfolio-guide-message"></p>'+
