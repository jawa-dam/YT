...
}function boot(){render();if(!document.querySelector('script[data-gei-v149-vault-interaction]')){const script=document.createElement("script");script.src="v1-46-achievement-vault-interaction.js";script.defer=true;script.dataset.geiV149VaultInteraction="true";document.head.appendChild(script)}if(!document.querySelector('link[data-gei-v149-reward-style]')){const link=document.createElement("link");link.rel="stylesheet";link.href="v1-47-achievement-reward-reveal.css";link.dataset.geiV149RewardStyle="true";document.head.appendChild(link)}if(!document.querySelector('script[data-gei-v149-reward-engine]')){const script=document.createElement("script");script.src="v1-47-achievement-reward-reveal.js";script.defer=true;script.dataset.geiV149RewardEngine="true";document.head.appendChild(script)}if(!document.querySelector('link[data-gei-v149-achievement-sound-style]')){const link=document.createElement("link");link.rel="stylesheet";link.href="v1-48-achievement-sound-engine.css";link.dataset.geiV149AchievementSoundStyle="true";document.head.appendChild(link)}if(!document.querySelector('script[data-gei-v149-achievement-sound-engine]')){const script=document.createElement("script");script.src="v1-48-achievement-sound-engine.js";script.defer=true;script.dataset.geiV149AchievementSoundEngine="true";document.head.appendChild(script)}}
