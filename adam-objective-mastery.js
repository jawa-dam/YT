/* V1.28/V1.29 — Adam Objective Mastery & Progress UX */
(() => {
  "use strict";
  ...
  function render() {
    ...
    renderQuestion();
    const count = document.getElementById("adam-mastery-progress-count");
    if (count) count.textContent = `${masteredCount(activeDay)} / 3`;
  }
