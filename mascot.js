...
(() => {
  ...
  function ensureAssistantStyles() {
    ...
    style.textContent = `
      ...
      .home-adam-assistant-backdrop { position:absolute;inset:0;z-index:0;border-radius:0;background:rgba(2,5,11,.58);backdrop-filter:blur(5px);-webkit-backdrop-filter:blur(5px);opacity:0;animation:adamAssistantBackdrop .2s ease-out forwards;pointer-events:auto;touch-action:manipulation;cursor:pointer; }
